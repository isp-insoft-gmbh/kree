...
| `fonts/NotoEmoji-Regular.ttf` | [Google Fonts: Noto Emoji](https://fonts.google.com/noto/specimen/Noto+Emoji) | OFL-1.1 | ~860 KB. Bundled monochrome emoji-symbol fallback. |
